const play = {
    ...
    nochannel: "You need to be in a voice channel dummy!",
    noresult: "No result found",
    loading: "Loading song...",
    songadded: " was added to the queue!",
    playlistOption: "Playlist URL"
}

const playlist = {
    command: "playlist",
    name: "url",
    description: "Play the specified playlist",
    option: "Playlist URL",
    nochannel: "You need to be in a voice channel dummy!",
    noresult: "No result found",
    loading: "Loading playlist...",
    playlistadded: " was added to the queue!",
}
